...
var cuenta = {
    ...
    amigos: [
        {
            numeroCta: "1234560023",
            nombre: "Alex Ventura"

        },
        {
            numeroCta: "78904630078",
...
function iniciarSesion() {
    ...
    if (nombreUsuario === cuenta.nombre && contrasena === cuenta.contrasena) {
        ...
        swal({
            ...
            text: "tu dinero a sido retenido por cuestiones de seguridad",
            icon: "error",
        });
    }
...
function transferirDineroVista() {
    ...
    document.getElementById('amigos-cuenta').innerHTML = cuenta.amigos.map(it => it.nombre + " " + it.numeroCta).join("<br>");
